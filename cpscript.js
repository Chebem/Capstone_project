async function fetchProductData() {
    ...
    try {
        ...
        const response = await fetch(`http://127.0.0.1:5001/compare?product=${encodeURIComponent(productName)}`);
        ...
        document.getElementById("productImage").src = data.image || "icons/default.jpg"; // Product Image
